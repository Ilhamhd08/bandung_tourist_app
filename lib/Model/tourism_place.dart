...
var tourismPlaceList = [
  TourismPlace(
    ...
    location: 'Lembang',
    description:
        'Berada di jalur utama Bandung-Lembang, Farm House menjadi objek wisata yang tidak pernah sepi pengunjung. Selain karena letaknya strategis, kawasan ini menghadirkan nuansa khas Eropa. Semua itu dterapkan dalm bentuk swafoto Instagramable.',
    openDays: 'Open Everyday',
    OpenTime: '09:00 - 20:00',
    ticketPrice: 'RP 25.000',
    imageAseet: 'images/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    location: 'Lembang',
    description:
        'Memiliki beberapa teleskop antara lain, Refraktor Ganda Zeiss, Schmidt Bimasakti, Refraktor Bamberg, Cassegrain GOTO, dan Teleskop Surya. Refraktor Ganda Zeiss adalah jenis teleskop terbesar untuk menerpong bintang. Benda ini diletakan pada ata kubah sehingga saat teropong digunakan atas tersebut harus dibuka. Observatorium Bosscha boleh dikunjungi oleh siapa pun tanpa tiket. Namun, bagi yang ingin menggunakan teleskop Zeiss wajib mendaftarkan diri untuk instansi atau lembaga pendidikan, diberikan jadwal hari Selasa s.d Jumat. Sementara itu kunjungan individu dibuka setiap hari Sabtu.',
    openDays: 'Open Tuesday - Saturday',
    OpenTime: '09:00 - 14.30',
    ticketPrice: 'RP 20.000',
    imageAseet: 'images/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    description:
        'Jalan Asia Afrika di Bandung memiliki kaitan yang erat dengan pendirian kota kembang ini. Karena pada saat itu, Gubernur Jendral Willem Deandels dari Belanda menancapkan tongkatnya saat memerintahkan pendirian kota ini, yang kemudian diabadikan menjadi tugu Bandung Nol Kilometer.',
    openDays: 'Open Everyday',
    OpenTime: ' 24 hours',
    ticketPrice: 'Free',
    imageAseet: 'images/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    location: 'Padalarang',
    description:
        'Stone Garden atau Taman Batu di Padalarang - Bandung ini adalah secara harfiah untuk apa yang akan kita lihat jika berada disana. Hamparan batu yang artistik membuat kita merasa tidak sedang berada di Bandung, apalagi di Padalarang. Hamparan batu yang dimaksud bukan terhampar begitu saja di atas tanah luas yang menjadi permukaannya. Batu-batu besar yang ukuran pastinya bervariasai tersusun seperti memiliki suatu informasi matematis.',
    openDays: 'Open Everyday',
    OpenTime: '06:00 - 17:00',
    ticketPrice: 'RP 3000',
    imageAseet: 'images/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    location: 'Kota Bandung',
    description:
        'Menjadi salah satu tempat wisata di Bandung yang terfavorit, tentu Film ini memiliki fasilitas cukup memadai. Pemberikan fasilitas ini memiliki harapan para pengunjung akan merasa nyaman dan tak segan-segan untuk kembali berkunjung terus menerus kesini. Beberapa fasilitas taman yang bisa kamu nikmati diantaranya seperti layar videotron besar ukuran 4x8 unutuk memutar berbagai macam pilihan film seperti Film Indonesia, Hollywood dan masih banyak lagi.',
    openDays: 'Open Everyday',
    OpenTime: '24 hours',
    ticketPrice: 'Free',
    imageAseet: 'images/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'RP 3000',
    imageAseet: 'images/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'RP 20.000',
    imageAseet: 'images/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAseet: 'images/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    OpenTime: '24 hours',
    ticketPrice: 'RP 20.000',
    imageAseet: 'images/ranca-upas.jpg',
    imageUrls: [
